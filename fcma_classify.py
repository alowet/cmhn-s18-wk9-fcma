...
second_mask = sys.argv[6]  # Do you want to supply a second mask (for extrinsic analysis)
...
if __name__ == '__main__':
    ...
    svm_clf = SVC(kernel='precomputed', shrinking=False, C=100)
    ...
    if MPI.COMM_WORLD.Get_rank()==0:
        ...
        with open('./classify_result.txt', 'a') as fp:
